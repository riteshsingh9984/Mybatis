				...
				<div class="row">
					<div class="col-lg-6">
						<form:form id="myForm" method="post"
							class="bs-example form-horizontal" modelAttribute="updateSave" action="updateSaveStudent.html">
							<fieldset>
								<legend>Student Enrollment Signup Form</legend>
								
								<div class="form-group">
									<label for="userNameInput" class="col-lg-3 control-label">User Id</label>
									<div class="col-lg-9">
										<form:input type="text" class="form-control" path="id"
											id="id" placeholder="User Id" value ="${student.id}" readonly="true" />
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
										<form:input type="text" class="form-control" path="userName"
											id="userNameInput" placeholder="User Name" value ="${student.userName}"/>
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
										<form:input type="password" class="form-control"
											path="password" id="passwordInput" placeholder="Password" value ="${student.password}" />
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
										<form:input type="text" class="form-control" path="firstName"
											id="firstNameInput" placeholder="First Name" value ="${student.firstName}"/>
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
										<form:input type="text" class="form-control" path="lastName"
											id="lastNameInput" placeholder="Last Name" value ="${student.lastName}" />
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
										<form:input type="text" class="form-control"
											...
											placeholder="Email Address" value ="${student.emailAddress}" />
